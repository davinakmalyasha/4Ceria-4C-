...
import { X, ChevronLeft, ChevronRight, Edit3, Trash2, Home, MapPin, Maximize, Bed, Bath, Layers, Info, Calendar, User } from 'lucide-react';
...
export default function PropertyDetailModal({ house, onClose, onEdit, onDelete, formatCurrency }: Props) {
