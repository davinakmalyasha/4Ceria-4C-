    ...
    return (
        <div className="bg-white border border-gray-100 rounded-[1.5rem] p-5 hover:border-zinc-900 group transition-all shadow-sm">
            <div className="flex items-start justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {(proType === 'arsitek' || proType === 'architect' || proType === 'kontraktor' || proType === 'contractor') && (
                                <button
                                    ...
                                    className="px-2 py-0.5 bg-slate-50 hover:bg-slate-100 text-slate-700 text-[9px] font-black uppercase tracking-widest rounded-md border border-slate-100 transition-all flex items-center gap-1 shrink-0 cursor-pointer"
                                >
                        ...
                        <div className="flex items-center gap-3 mt-1.5">
                            <div className="flex flex-col">
                                    <div className="flex items-center gap-1.5">
                                        {showFinancials ? (
                                            ...
                                            <div className="px-3 py-1 bg-slate-50 text-slate-700 rounded-full border border-slate-150 shadow-sm flex items-center gap-1.5">
                                                <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">Est. Bid:</span>
                                                <span className="text-xs font-black">
                                                    {bid.fee_type === 'percentage' ? (
                            ...
                            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-50 text-slate-700 rounded-full border border-slate-100 shadow-sm animate-in fade-in slide-in-from-left-4 duration-700">
                        ...
                        <div className="flex flex-wrap gap-2 items-center mt-3 text-xs font-semibold text-zinc-600">
                            ...
                            {terminsList && terminsList.length > 0 && (
                                <div className="flex items-center gap-1.5 px-2.5 py-1 bg-slate-50/50 text-slate-700 rounded-lg border border-slate-100/30 text-[10px]">
                                    <span className="text-[9px] font-black uppercase text-slate-400">Schedule:</span>
                            ...
                            {(!terminsList || terminsList.length === 0) && milestonesList && milestonesList.length > 0 && (
                                <div className="flex items-center gap-1.5 px-2.5 py-1 bg-slate-50/50 text-slate-750 rounded-lg border border-slate-100/30 text-[10px]">
                                    <span className="text-[9px] font-black uppercase text-slate-400">Milestones:</span>
                                    <div className="flex items-center gap-1 font-bold">
                        ...
                        {!isReadOnly && (
                            <div className="flex gap-2">
                                ...
                                <button 
                                    ...
                                    disabled={isActioning}
                                    className="px-6 py-2.5 bg-zinc-900 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-zinc-800 shadow-lg shadow-slate-200 transition-all flex items-center gap-2 disabled:opacity-50"
                                >
                        ...
                        {!isThePro && (
                            <div className="flex items-center gap-2 mt-2">
                                ...
                                <button 
                                    ...
                                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-zinc-900 text-white rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-zinc-800 transition-all shadow-sm"
                                >
                ...
                {bid.status === 'invited' && (
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-50 text-slate-700 rounded-full border border-slate-200 shadow-sm">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {hasHistory && (
                                    <button 
                                        ...
                                        className="text-[8px] font-black text-slate-600 uppercase hover:underline"
                                    >
                                        View History
                                    </button>
                                )}
                    ...
                    return (
                        <div className="flex flex-col gap-2">
                            {hasPaidTermin ? (
                                ...
                                <div className="flex items-center gap-2 px-4 py-2 bg-slate-50 text-slate-700 rounded-xl border border-slate-200 shadow-sm animate-pulse">
                                    <Clock size={16} />
                        ...
                        {phaseKey === 'engineering' && (
                            <div className="space-y-8 animate-in fade-in duration-500">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest flex items-center gap-2">
                                            <FileText size={12} className="text-slate-500" /> Technical Assumptions
                                        </label>
