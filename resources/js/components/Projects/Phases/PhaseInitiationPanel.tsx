            ...
            <div className="bg-white border-2 border-slate-900 rounded-[3rem] p-10 shadow-2xl relative overflow-hidden group">
                ...
                <div className="relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                        {/* Option 1: Broadcast */}
                        <div 
                            className={`bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-[2.5rem] p-8 transition-all group/card cursor-pointer flex flex-col justify-between ${isBroadcasting ? 'opacity-50 pointer-events-none' : ''}`} 
                            onClick={() => !isBroadcasting && handleBroadcast()}
                        >
                            <div>
                        ...
                        {/* Option 2: Import */}
                        <div 
                            className={`bg-slate-900 hover:bg-black border border-slate-800 rounded-[2.5rem] p-8 transition-all group/card cursor-pointer flex flex-col justify-between shadow-xl ${isBroadcasting ? 'opacity-50 pointer-events-none' : ''}`} 
                            onClick={() => !isBroadcasting && setShowImportModal(true)}
                        >
                            <div>
