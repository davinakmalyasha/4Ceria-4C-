    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
            ...
            <motion.div 
                ...
                className={`bg-white rounded-[1.5rem] p-5 lg:p-6 border border-gray-100 shadow-sm relative overflow-hidden flex flex-col justify-between ${isClickable ? 'cursor-pointer hover:shadow-md hover:border-zinc-200 transition-all group' : ''}`}
            >
                <div>
                    <div className="flex items-center gap-2 text-gray-500 mb-2">
                        <div className={`p-1.5 rounded-lg bg-zinc-50 text-zinc-600`}>
                    ...
                    <p className={`text-3xl lg:text-4xl font-black text-gray-900 tracking-tight ${isClickable ? 'group-hover:text-zinc-600' : ''} transition-colors`}>
                        {activeBids}
                    </p>
                </div>
                <div className="mt-4 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <span className="relative flex h-2.5 w-2.5">
                            <span className={`animate-ping absolute inline-flex h-full w-full rounded-full opacity-75 bg-zinc-300`}></span>
                    ...
                    {isClickable && (
                        <div className={`text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1 text-zinc-600`}>
                            View &rarr;
                        </div>
                    )}
                </div>
