...
<div class="rating-container">
    <a href="{{ route('users-page.adminKontraktor') }}" class="back-link">← Kembali ke Forum</a>
            ...
            @foreach($riwayats as $riwayat)
                <div class="rating-card">
                    <div class="card-header">
                        <h3 class="project-title">{{ $riwayat->project->title ?? 'Judul Proyek Tidak Ditemukan' }}</h3>
